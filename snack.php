  ...
  <br><br><br><br>
    ...
    <div class="row mt-2 pb-3">
      <?php
        ...
        $query = "SELECT * FROM snack WHERE blocked = 0 AND name LIKE '%$searchTerm%'";
        ...
        <div class="card-deck">
          <div class="card p-2 border-secondary mb-2">
            ...
            <div class="card-body p-1">
              <h4 class="card-title text-center text-info"><?= $row['name'] ?></h4><br> 
...
$(document).ready(function() {
  ...
  $('#searchForm').submit(function(e) {
    ...
    window.location.href = 'snack.php?search=' + encodeURIComponent(searchTerm);
  });
});
  </script>
