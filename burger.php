...
<br><br><br><br><br>
  ...
  include 'Connectdb.php';
      $searchTerm = isset($_GET['search']) ? $_GET['search'] : '';
        ...
        $query = "SELECT * FROM burger WHERE blocked = 0 AND name LIKE '%$searchTerm%'";
  ...
  ?>
      <div class="col-sm-6 col-md-4 col-lg-3 mb-2">
        <div class="card-deck">
          ...
          <a href="detailburger.php?id=<?= $row['id'] ?>">
                <img src="<?= $row['image'] ?>" class="card-img-top" height="250">
              </a>
            <div class="card-body p-1">
              <h4 class="card-title text-center text-info"><?= $row['name'] ?> (Regular)</h4><br> 
...
$(document).ready(function() {
  ...
  $('#searchForm').submit(function(e) {
    ...
    window.location.href = 'burger.php?search=' + encodeURIComponent(searchTerm);
  });
});
  </script>
</body>
