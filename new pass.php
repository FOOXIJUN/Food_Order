        ...
        <?php
            ...
            if (isset($_POST['new_password']) && isset($_POST['confirm_password'])) {
                 ...
                 if ($_POST['new_password'] === $_POST['confirm_password']) {
                     ...
                     mysqli_query($conn, "update customer set Password='$new_password' where password='$password'");
                     // Show success message and redirect to mainmenu.php after a delay
                     echo "<script>alert('Password updated successfully!');setTimeout(function(){window.location.href='customerprofile.php';}, 500);</script>";
                 } else {
