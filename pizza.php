...
<br><br><br><br><br>
  ...
  include 'Connectdb.php';
      $searchTerm = isset($_GET['search']) ? $_GET['search'] : '';
        ...
        $query = "SELECT * FROM pizza WHERE blocked = 0 AND name LIKE '%$searchTerm%'";
  ...
  ?>
      <div class="col-sm-6 col-md-4 col-lg-3 mb-2">
        <div class="card-deck">
          ...
          <a href="detailpizza.php?id=<?= $row['id'] ?>">
...
$(document).ready(function() {
  ...
  $('#searchForm').submit(function(e) {
    ...
    window.location.href = 'pizza.php?search=' + encodeURIComponent(searchTerm);
  });
});
  </script>
</body>
